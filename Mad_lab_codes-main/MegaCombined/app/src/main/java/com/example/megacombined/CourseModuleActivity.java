...
public class CourseModuleActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Course Enrollment");

        btnBook.setOnClickListener(v -> startActivity(new Intent(this, CourseUserDetailsActivity.class)));
        btnView.setOnClickListener(v -> startActivity(new Intent(this, CourseListActivity.class)));
    }
}
