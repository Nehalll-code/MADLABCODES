...
public class VehicleModuleActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Vehicle Service");

        btnBook.setOnClickListener(v -> startActivity(new Intent(this, VehicleUserDetailsActivity.class)));
        btnView.setOnClickListener(v -> startActivity(new Intent(this, VehicleListActivity.class)));
    }
}
