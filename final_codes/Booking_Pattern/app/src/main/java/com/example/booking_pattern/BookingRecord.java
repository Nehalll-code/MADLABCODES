...
public class BookingRecord implements Serializable {
    ...
    public BookingRecord(int id, String name, int age, String email, String category, String date, String time, String type, String notification) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.email = email;
    ...
    public BookingRecord(String name, int age, String email, String category, String date, String time, String type, String notification) {
        this.id = -1; // -1 indicates new record not yet in DB
        this.name = name;
        this.age = age;
        this.email = email;
        this.category = category;
